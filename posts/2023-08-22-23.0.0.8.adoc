...
For link:{url-prefix}/guides/maven-intro.html[Maven projects], use the link:https://github.com/OpenLiberty/ci.maven/blob/main/README.md#plugins[Liberty Maven Plugin] for quicker and easier development:
...
For link:{url-prefix}/guides/gradle-intro.html[Gradle projects], use the link:https://github.com/OpenLiberty/ci.gradle/blob/main/README.md#usage[Liberty Gradle Plugin] for quicker and easier development:
