...
// // // // // // // //
[#mq]
== InstantOn support for IBM® MQ messaging
...
.Developer tip
--
You can use the link:https://developer.ibm.com/tutorials/mq-connect-app-queue-manager-containers/[MQ in Container image] IBM® MQ server that provides the following resources: queue manager `QM1` listening on port 1414, queue `DEV.QUEUE.1`, and channel `DEV.APP.SVRCONN`.
--
