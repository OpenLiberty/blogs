...
== Provisioning and configuring Travis CI and OpenShift for CI/CD of Open Liberty applications ==
...
Login to OpenShift from CLI and create a new project/namespace. Create OpenShift secrets to checkout the code from GitHub to OpenShift (upload the public to github ), another one for accessing dockerhub repository from OpenShift
