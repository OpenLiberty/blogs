...
The standard Dockerfile that you use in general is not enough to do the Jakarta EE & MicroProfile with Open Liberty application deployment on containerized environment. A sample Openliberty compliant Dockerfile snipped in given, you can configure it as needed.
