...
Travis CI provides wide variety of configuration options, below given is a workable sample travis ci code which is good enough to automate the code build
     ...
     script:
       - mvn package #maven build command
