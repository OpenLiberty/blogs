...
seo-description: How we implemented a multiplayer browser game as microservices with Open Liberty and MicroProfile.
blog_description: How we implemented a multiplayer browser game as microservices with Open Liberty and MicroProfile.
