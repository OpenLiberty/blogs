---
layout: post
title: "Distributed tracing on Red Hat OpenShift with Jaeger"
categories: blog
author_picture: https://avatars3.githubusercontent.com/fwji
author_github: https://github.com/fwji
seo-title: Distributed tracing on Red Hat OpenShift with Jaeger - OpenLiberty.io
...
---
= Distributed tracing on Red Hat OpenShift with Jaeger
