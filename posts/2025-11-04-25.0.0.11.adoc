...
//   Replace 25.0.0.11 with the version number of Open Liberty, eg: 22.0.0.2
//   Replace 250011 with the version number of Open Liberty wihtout the periods, eg: 22002
// // // // // // // //

In link:{url-about}[Open Liberty] 25.0.0.11:
...
View the list of fixed bugs in link:https://github.com/OpenLiberty/open-liberty/issues?q=label%3Arelease%3A250011+label%3A%22release+bug%22[25.0.0.11].
