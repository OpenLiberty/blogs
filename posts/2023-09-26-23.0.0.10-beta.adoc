...
For more information and an example Spring Boot application using the Liberty InstantOn `crac-1.3` feature see the link:/blog/2023/09/25/spring-boot-3-instant-on.html[How to containerize your Spring Boot application for rapid startup] blog post.
