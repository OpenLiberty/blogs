...
seo-title: Liberty Build Plugins Java Toolchain Support
seo-description: Learn how to use Java Toolchains with the Liberty Maven Plugin (v3.12.0+) and Liberty Gradle Plugin (v3.10.0+) to decouple your build environment from your runtime. Discover how to configure toolchains, ensure JDK consistency in Dev Mode, and manage precedence for Surefire and Failsafe plugins for seamless Liberty development.
blog_description: "Learn how to use Java Toolchains with the Liberty Maven Plugin (v3.12.0+) and Liberty Gradle Plugin (v3.10.0+) to decouple your build environment from your runtime. Discover how to configure toolchains, ensure JDK consistency in Dev Mode, and manage precedence for Surefire and Failsafe plugins for seamless Liberty development."
...
1. **Manual Overrides**: If `JAVA_HOME` is set in `server.env` or `jvm.options`, *that value takes precedence* over the Java toolchain.
...
* For Maven issues, visit the link:https://github.com/OpenLiberty/ci.maven/issues[Liberty Maven Plugin GitHub Issues].
* For Gradle issues, visit the link:https://github.com/OpenLiberty/ci.gradle/issues[Liberty Gradle Plugin GitHub Issues].
// // // // // // // //
// LINKS
//
