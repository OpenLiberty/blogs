...
* <<admincenter, Admin Center feature now available in Open Liberty 21.0.0.4>>
...
The adminCenter-1.0 feature enables the Liberty Administrative Center (“Admin Center”), a web-based graphical interface for deploying, monitoring and managing Liberty servers. 

For more information about how to use this new feature, check out the link:{url-prefix}/blog/2021/04/15/admin-center-21004.html[Admin Center feature now available in Open Liberty 21.0.0.4 blog post]
