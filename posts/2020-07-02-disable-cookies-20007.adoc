...
Available through <<run,Maven, Gradle, Docker, and as a downloadable archive>>. If you use the downloadable archive, you now have the option to download just the Kernel package. Use the link:{url-prefix}/blog/2020/06/05/graphql-open-liberty-20006.html#MVN[featureUtility command] to add the features that you need to the kernel.
