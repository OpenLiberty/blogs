...
OpenLibertyのガイドは、JakartaEEとMicroProfileを使ってクラウドネイティブのJavaアプリケーションの開発を紹介します。簡単なマイクロサービスを作成し、コンテナ化、それをKubernetes環境にデプロイする方法を順を追って説明しています。
...
本記事では、OpenLibertyの英語版の開発ガイドを、ブラウザ付属の翻訳ツールを使って、日本語表示にした例を最初にご紹介します。

次に、OpenLibertyガイドの構成と概要をみていきます。読者の興味や必要に応じて、順を追って学習することも、興味のあるトピックだけ試すことも出来ます。
