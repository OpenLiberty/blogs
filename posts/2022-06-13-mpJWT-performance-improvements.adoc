...
I used https://jmeter.apache.org[Apache JMeter] to apply a load with 100 clients. Each client generates a JWT, uses it around 20 times to access the endpoint, then generates a new JWT. 
...
https://github.com/jhanders34[Jared Anderson] fixed this with the following PR: https://github.com/OpenLiberty/open-liberty/pull/20334
