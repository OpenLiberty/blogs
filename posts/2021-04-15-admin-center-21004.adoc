...
If you configured link:https://openliberty.io/docs/21.0.0.3/reference/feature/openidConnectServer-1.0.html[openidConnectServer-1.0] feature, you can access the Admin Center OIDC tools.
