...
View the list of fixed bugs from https://github.com/OpenLiberty/open-liberty/issues?utf8=✓&q=label%3Arelease%3A19005+label%3A%22release+bug%22[19.0.0.5]
...
See also: link:{url-prefix}/docs/ref/general/#java-se.html[Java SE support on Open Liberty]
