...
- There are multiple Java distributions; find out more in link:Where do you get your Java[https://foojay.io/today/where-do-you-get-your-java/]?

Once Java installation is completed, please ensure the JAVA_HOME variable have been properly config in your system path. The `JAVA_HOME` variable is essential for Maven and Gradle Liberty projects. It helps to indicate which JVM to use. If the JVM is not set, the system default is used.

// might need instruction for setting up JAVA_HOME for Mac, Win & Linux
