...
seo-description: The 25.0.0.2 release includes 256-bit AES password encryption, updates our Open Liberty guides, and a CVE fix.
blog_description: The 25.0.0.2 release includes 256-bit AES password encryption, updates our Open Liberty guides, and a CVE fix.
...
The 25.0.0.2 release includes 256-bit AES password encryption, updates our Open Liberty guides, and a CVE fix.


In link:{url-about}[Open Liberty] 25.0.0.2:

* <<aes, Support for AES-256 password encryption>>
* <<guides, Guides updated>>
...
- All guides except those that are marked **Deprecated** are updated to use MicroProfile 7 and link:https://openliberty.io/docs/latest/reference/feature/versionless-features.html[versionless features].
