...
The `featureUtility` command-line tool, Liberty Maven and Gradle plugins will now enable installation of user features onto Open Liberty runtime from Maven Central and on-premises Maven repository.
