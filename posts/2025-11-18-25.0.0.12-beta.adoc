---
layout: post
title: "SpringBoot 4.0, preview of Jakarta Data 1.1 and more in 25.0.0.12-beta"
# Do NOT change the categories section
categories: blog
author_picture: https://avatars3.githubusercontent.com/navaneethsnair1
author_github: https://github.com/navaneethsnair1
seo-title: "SpringBoot 4.0, preview of Jakarta Data 1.1 and more in 25.0.0.12-beta- OpenLiberty.io"
seo-description: This beta release adds Spring Boot 4.x support, previews Jakarta Data 1.1 capabilities, and enhances the Netty-based HTTP transport. It also updates Model Context Protocol Server 1.0 and introduces the option to use your own AES-256 key for Liberty password encryption.
blog_description: This beta release adds Spring Boot 4.x support, previews Jakarta Data 1.1 capabilities, and enhances the Netty-based HTTP transport. It also updates Model Context Protocol Server 1.0 and introduces the option to use your own AES-256 key for Liberty password encryption.
...
* <<jakarta, Early preview of Jakarta Data 1.1>>
* <<mcp, Model Context Protocol Server 1.0 updates>>
* <<netty, Updates to Netty‑based HTTP transport on Open Liberty>>
