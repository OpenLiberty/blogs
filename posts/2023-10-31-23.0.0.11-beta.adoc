---
layout: post
title: "New vendor metrics and MicroProfile Reactive Messaging updates available in Open Liberty 23.0.0.11-beta"
# Do NOT change the categories section
categories: blog
author_picture: https://avatars3.githubusercontent.com/lauracowen
author_github: https://github.com/lauracowen
seo-title: New vendor metrics and MicroProfile Reactive Messaging updates available in Open Liberty 23.0.0.11-beta - OpenLiberty.io
...
---
= New vendor metrics and MicroProfile Reactive Messaging updates available in Open Liberty 23.0.0.11-beta
