...
image::/img/blog/azure-deploy1.png[Azure devops deployment pipeline setup stage 1 diagram,width=50%,align="center"]
...
image::/img/blog/azure-deploy2.png[Azure devops deployment pipeline setup stage 2 diagram,width=50%,align="center"]
...
image::/img/blog/azure-deploy3.png[Azure devops deployment pipeline setup stage 3 diagram,width=50%,align="center"] 
 
                      * Add a task to the Agent job by clicking on the '+' button on 'Agent job'

image::/img/blog/azure-deploy4.png[Azure devops deployment pipeline setup stage 4 diagram,width=50%,align="center"]
