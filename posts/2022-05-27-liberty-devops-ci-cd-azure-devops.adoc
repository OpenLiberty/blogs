...
image::/img/blog/azure-deploy8.png[Azure devops deployment pipeline run stage 1 diagram,width=90%,align="center"] 

           * When the build status is 'success', a deployment will be automatically created and executed.

image::/img/blog/azure-deploy9.png[Azure devops deployment pipeline run stage 2 diagram,width=90%,align="center"]  
