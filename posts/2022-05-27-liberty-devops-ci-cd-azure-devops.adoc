...
== Provisioning Microsoft Azure resources to set up CI/CD of a cloud-native Java application

<b>Account creation:</b> Login to link:https://portal.azure.com[Microsoft Azure] and subscribe to "Pay as you go with Azure". 
Goto home page of link:https://portal.azure.com[Microsoft Azure] and click on "Create a resource" button. Search for 
