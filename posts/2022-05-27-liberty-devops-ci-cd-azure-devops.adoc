...
image::/img/blog/azure-deploy6.png[Azure devops deployment pipeline setup stage 1 diagram,width=50%,align="center"]
...
image::/img/blog/azure-deploy5.png[Azure devops deployment pipeline setup stage 6 diagram,width=50%,align="center"]
