...
** <<conf, Support for new features defined in MicroProfile 2.0>>
...
Other MicroProfile 4.0 features were part of earlier betas; with MicroProfile Fault Tolerance 3.0, MicroProfile Metrics 3.0, MicroProfile Health 3.0, and MicroProfile OpenTracing 2.0 in the Open Liberty link:{url-prefix}/blog/2020/09/02/jakarta-microprofile-beta-200010.html#allbeta[20.0.0.10-beta], followed by MicroProfile OpenAPI 2.0 in link:{url-prefix}/blog/2020/09/29/microprofile-openapi-beta-200011.html#openAPI[20.0.0.11-beta]. While we'd hoped to also include MicroProfile Rest Client 2.0 (also part of MicroProfile 4.0), we didn't quite make it this time so it will make its debut in a future beta.
