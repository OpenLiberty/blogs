...
//
// Throughout the doc, replace 24.0.0.3-beta with the version number of Open Liberty, eg: 22.0.0.2-beta
// // // // // // // //

The link:{url-about}[Open Liberty] 24.0.0.3-beta includes the following beta features (along with link:{url-prefix}/docs/latest/reference/feature/feature-overview.html[all GA features]):
...
// "The link:{url-about}[Open Liberty] 24.0.0.3-beta includes SUB_FEATURE_TITLE"
// // // // // // // //
...
dependencies {
    libertyRuntime group: 'io.openliberty.beta', name: 'openliberty-runtime', version: '[24.0.0.3-beta,)'
}
----
// // // // // // // //
// In the preceding section:
