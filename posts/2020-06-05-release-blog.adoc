...
seo-description: Open Liberty 20.0.0.6 now provides developers with here is now official support for GraphQL to allow the development of "code-first" GraphQL applications. In addition, users can now control the start up order of their applications using the server.xml.
blog_description: Open Liberty 20.0.0.6 now provides developers with here is now official support for GraphQL to allow the development of "code-first" GraphQL applications. In addition, users can now control the start up order of their applications using the server.xml.
---
...
Open Liberty 20.0.0.6 now provides developers with here is now official support for GraphQL to allow the development of "code-first" GraphQL applications. In addition, users can now control the start up order of their applications using the `server.xml`.
