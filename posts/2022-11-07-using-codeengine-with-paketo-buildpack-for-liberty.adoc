---
layout: post
title: "Deploy Java application to IBM Cloud Code Engine using the Paketo Buildpack for Liberty"
# Do NOT change the categories section
categories: blog
author_picture: https://avatars3.githubusercontent.com/kevin-ortega
author_github: https://github.com/kevin-ortega
seo-title:  Deploy Java application to IBM Cloud Code Engine (ICCE) using the Paketo Buildpack for Liberty - OpenLiberty.io
...
---
= Deploy Java application to IBM Cloud Code Engine using the Paketo Buildpack for Liberty
Kevin Ortega <https://github.com/kevin-ortega>
:imagesdir: /
:url-prefix:
:url-about: /

IBM Cloud has announced the link:https://cloud.ibm.com/docs/cloud-foundry-public?topic=cloud-foundry-public-deprecation[deprecation of Cloud Foundry]. link:https://www.ibm.com/cloud/code-engine[IBM Cloud Code Engine] provides the next level of easy application deployment and mature management of critical business applications in IBM Cloud.  Open Liberty is easily available to deploy Java applications to Code Engine with the link:https://openliberty.io/blog/2022/04/01/cloud-native-liberty-buildpack.html[Paketo Buildpack for Liberty] using container images or your source code. 

The intent of this blog is not a Code Engine tutorial but to provide instructions on how to use the Liberty Cloud Native buildpack in Code Engine. 
...
Login to the IBM Cloud console and head to the link:https://cloud.ibm.com/codeengine/overview[Code Engine overview] page.  When building from source, enter the url of the respository hosting your source. 
[.img_border_light]
image:/img/blog/code_engine_overview.png[IBM Cloud Code Engine Overview,width=70%,align="center"]

On the `Start creating` page it's important to enter the `9080` for `Listening port`.
[.img_border_light]
...
[.img_border_light]
image:/img/blog/code_engine_build_details.png[Build details,width=70%,align="center]
[.img_border_light]
...
[.img_border_light]
image:/img/blog/code_engine_build_step_details.png[Build output,width=70%,align="center"]

Similarly, if you're creating your app from source using the Code Engine CLI you need to specify the `port` and build strategy along with the `.buildenv` file present in the application source root directory:
