...
Open Liberty 21.0.0.7 comes without any new features but a number of signifcant bug fixes. The majority of the work in this release went into our Beta version. You can find a link to our 21.0.0.8-beta here shortly, so keep an eye out!
...
We’ve spent some time fixing bugs. The following sections describe just some of the issues resolved in this release. If you’re interested, here’s the  link:https://github.com/OpenLiberty/open-liberty/issues?q=is%3Aissue+label%3Arelease%3A21007+is%3Aclosed+label%3A%22release+bug%22[full list of bugs fixed in 21.0.0.7].
