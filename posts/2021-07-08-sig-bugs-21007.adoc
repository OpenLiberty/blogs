...
Open Liberty 21.0.0.7 comes without any new features but a number of signifcant bug fixes. The majority of the work in this release went into our Beta version. You can find out more about 21.0.0.8-beta link:{url-prefix}blog/2021/07/12/logging-format-21008-beta.html[here].
