...
Github 
- Sign up and sign in to https://github.com[Github]
- Go to your https://github.com/settings/personal-access-tokens[Settings/Developer Settings/Personal access tokens]
...
- Pull the following models: `ollama pull nomic-embed-text`

Mistral AI
- Sign up and log in to https://console.mistral.ai/home[Mistral AI]
