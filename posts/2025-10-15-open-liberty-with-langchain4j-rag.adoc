...
See sample-langchain4j/rag-db/src/main/java/io/openliberty/sample/langchain4j/mongo/MongoProducer.java[MongoProducer.java].
...
To fine tune the LangChain4j model or even try out another LLM, you simply update the values in the [microprofile-config.properties]https://github.com/OpenLiberty/sample-langchain4j/blob/main/rag-db/src/main/resources/META-INF/microprofile-config.properties or provide them through the environment variables.
