...
- https://developer.ibm.com/languages/java/semeru-runtimes/downloads[Java 21]
- Choose either one of the following model providers:
  - Github
    - Sign up and sign in to https://github.com[Github]
    - Go to your https://github.com/settings/profile[Settings]/https://github.com/settings/developers[Developer Settings]/https://github.com/settings/personal-access-tokens[Persional access tokens]
