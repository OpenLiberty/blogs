...
You're welcome to propose new guides by writing an outline for consideration. Especially if you can contribute in some way once the guide has been accepted, whether that's by writing the guide, writing some code, or both.

If you see any errors in our existing guides, feel free to raise an issue against that guide's GitHub repository or to create a PR to fix it.

In the meantime though, link:{url-prefix}/guides/[browse our 50+ guides].