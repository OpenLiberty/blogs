...
For Docker image scan, you can use link:https://hub.docker.com/r/aquasec/trivy/[Docker image scan with trivy]. This scan will provide the vulnerability details of open source jars used in the application
