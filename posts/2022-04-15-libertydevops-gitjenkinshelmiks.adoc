...
Build your container image using a Dockerfile or a Containerfile generated by link:start.openliberty.io[Liberty Starter] or by following the pattern described at link:https://github.com/OpenLiberty/ci.docker[ci.docker on GitHub]. The link:/guides/containerize.html[Containerize guide] is a helpful resource that goes into more details on how to create a container image for applications running on Liberty.
