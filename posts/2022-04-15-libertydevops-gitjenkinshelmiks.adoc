...
* Vulnerability scanning tools, like Aqua, Trivy, NexusIQ, Sonarqube (optional)
      ...
      production deployed to make sure that its free of any critical vulnerabilities. Sonarqube is the most popular tool used for static code analysis, you can do the basic scanning using the opensource version of this software "https://www.sonarqube.org/downloads/", "https://docs.sonarqube.org/latest/analysis/scan/sonarscanner-for-jenkins/"
