...
image::/img/blog/multiple-branch-pipeline-jenkinsview-with-corresponding-gitview.png[Multi branch pipeline setup and corresponding git view,width=40%,align="left"]
