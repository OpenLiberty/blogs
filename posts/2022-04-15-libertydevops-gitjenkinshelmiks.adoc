...
* Vulnerability scanning tools, like Aqua, Trivy, NexusIQ, Sonarqube (optional)
      ...
      Licenses software like sonatype nexusiq and aqua can be used for opensource jar scan and its remediation recommendantions "https://support.aquasec.com/support/solutions/articles/16000112614-aqua-onboarding-guide", "https://help.sonatype.com/iqserver/getting-started".
