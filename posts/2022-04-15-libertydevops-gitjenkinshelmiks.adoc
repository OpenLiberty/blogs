...
* Vulnerability scanning tools, like Aqua, Trivy, NexusIQ, Sonarqube (optional)
      ...
      Most of the scanning softwares do have a recommendation section which we can use to select the correct jar (please verify the database against 
      ...
      can develop your own custom rules against which you can scan your code before production deployment to find out any critical faults. 
      Softwares like Aqua (docker image scan), SonarQube (static code analysis), 
