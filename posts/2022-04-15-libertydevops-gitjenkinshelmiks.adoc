...
image::/img/blog/kubernetes-configuration-files-in-github.png[Kubernetes configuration files in github,width=30%,align="center"]

-> Sample kubernetes deployment file

image::/img/blog/sample-k8s-app-deployment-file.png[Sample kubernetes deployment configuration files in github,width=30%,align="center"]


Helm is a good option to facilitate the application deployment on the cloud platform, it eases deployment/maintenance steps. But we can do the application deployment on kubernetes using CLI commands directly from Jenkins shell or pipeline stages. 
