...
image::/img/blog/jenkins-cred-binding.png[Pipeline credential binding ,width=50%,align="center"]

image::/img/blog/jenkins-parameter.png[Pipeline parameter binding ,width=50%,align="center"]
