...
image::/img/blog/multiple-branch-pipeline-jenkinsview.png[Multi branch pipeline setup ,width=40%,align="left"]
image::/img/blog/multiple-branch-pipeline-gitview.png[Multi branch git view ,width=30%,align="right"]
