...
* Maven repository and Docker image repository, like artifactory (optional)
     ...
     Artifactory is another popular software in the market for 
     this "https://www.jfrog.com/confluence/display/JFROG/Getting+Started+with+Artifactory+as+a+Docker+Registry"
