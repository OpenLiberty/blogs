...
image::/img/blog/jenkins-cred-binding.png[Pipeline credential binding ,width=20%,align="center"]

image::/img/blog/jenkins-parameter.png[Pipeline parameter binding ,width=20%,align="center"]
