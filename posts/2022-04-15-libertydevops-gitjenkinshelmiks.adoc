...
image::/img/blog/jenkins-cred-binding.png[Pipeline credential binding ,width=30%,align="center"]

image::/img/blog/jenkins-parameter.png[Pipeline parameter binding ,width=30%,align="center"]
