...
Artifactory is another popular software in the market for this link:https://www.jfrog.com/confluence/display/JFROG/Getting+Started+with+Artifactory+as+a+Docker+Registry[Artifactory as Docker Registry]
