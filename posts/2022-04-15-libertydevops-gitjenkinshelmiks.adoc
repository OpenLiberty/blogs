...
image::/img/blog/jenkins-cred-binding.png[Pipeline credential binding ,width=10%,align="center"]

image::/img/blog/jenkins-parameter.png[Pipeline parameter binding ,width=10%,align="center"]
