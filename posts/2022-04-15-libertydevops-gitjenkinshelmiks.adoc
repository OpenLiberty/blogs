...
Docker and Kubernetes knowledge is mandatory to understand the details given in this blog. 
...
* Vulnerability scanning tools, like Aqua, Trivy, NexusIQ, Sonarqube (optional)
      ...
      Softwares like Aqua (docker image scan), SonarQube (static code analysis), NexusIQ (jar scan) are popular in market for this. 
