...
With Open Liberty 20.0.0.10 you can now install a certificate authority signed certificate using the ACME protocol with the acmeCA-2.0 feature for improved testing or user experience. Also in this release there are a number of significant bug fixes.
