...
Open Liberty 21.0.0.1-beta comes with MP Rest Client 2.0 (which is part of MicoProfile 4.0), this update adds support for HTTP procy servers and automatically following HTTP redirects. In 21.0.0.1-beta you can now use Kubernetes secrets in Liberty variables. Plus Jakarta Faces Container 3.0 and Jakarta Enterprise Beans Persistent Timer 4.0 included in Jakarta EE 9.
...
* Jakarta Enterprise Beans Remote 4.0 (`enterpriseBeansPersistentTimer-4.0`)
