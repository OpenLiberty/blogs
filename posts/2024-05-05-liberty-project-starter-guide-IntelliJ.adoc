...
seo-description: This blog is designed to assist users in initiating their journey with the Liberty Maven or Gradle project with IntelliJ IDEA. It aims to help users understand how to set up the required Liberty environment using Open Liberty Starter, navigate Maven/Gradle project structures, and use Liberty tools within an IDE.
blog_description: This blog is designed to assist users in initiating their journey with the Liberty Maven or Gradle project with IntelliJ IDEA. It aims to help users understand how to set up the required Liberty environment using Open Liberty Starter, navigate Maven/Gradle project structures, and use Liberty tools within an IDE.
...
* <<libertyStarter, Creating a Liberty Maven/Gradle project with Efficiency: Open Liberty Starter>>
...
[#libertyStarter]
== Creating a Liberty Maven/Gradle project with Efficiency: Open Liberty Starter
...
This section provides links to the installation documents for the Liberty Tools on specific IDEs, such as IntelliJ IDEA.
...
When using IntelliJ IDEA, you have the option to either navigate to `File` > `Open...` within the IDE or simply drag and drop the project folder into the IDE window for seamless integration.
...
image::img/blog/Liberty-Tools-Example.png[Liberty Tools Example image, title="An example integrating Liberty Dashboard from Liberty Tools into a Maven or Gradle project with IntelliJ IDEA", width=50%,align="center"]
