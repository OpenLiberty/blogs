...
Graph databases available today are *Neo4J*, *Arango DB*, *OrientDB*, *JanusGraph*, among others. The last one mentioned is an open source technologies.
...
Furthermore, in the cloud era of consumption-based pricing models, we must consider ways to deliver solutions with efficient resource consumption for costs reduction. This is how potential discussions may arise, opening possibility for consider changes of the underlying database used by existing applications.
