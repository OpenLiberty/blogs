...
seo-description: Learn how Jakarta NoSQL together with Jakarta Data can ease the development process for Java developers using NoSQL databases with Liberty. The Jakarta NoSQL specification provides a standard-based, easy-to-learn framework that mirrors the familiar JPA, simplifying development across various NoSQL databases.

blog_description: "Learn how Jakarta NoSQL together with Jakarta Data can ease the development process for Java developers using NoSQL databases with Liberty. The Jakarta NoSQL specification provides a standard-based, easy-to-learn framework that mirrors the familiar JPA, simplifying development across various NoSQL databases."
...
Fortunately, the Java community adopting NoSQL storage solutions no longer needs to worry about these concerns. The Jakarta NoSQL specification offers a well-defined, standard-based implementation with a low learning curve and familiar coding APIs, thanks to its similarities with the widely-adopted JPA specification.
...
After getting an overview about the Jakarta NoSQL, Jakarta Data, and the Eclipse JNoSQL, I invite you to explore these tools on a hands-on approach, managing and querying data from NoSQL databases and switching between NoSQL databases as needed.

// This blog post is the 1st part of a set of blog posts:
//
...
To see same sample projects, take a look at the official Eclipse JNoSQL samples repositories:
