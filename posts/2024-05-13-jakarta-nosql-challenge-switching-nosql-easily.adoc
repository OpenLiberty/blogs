...
. Define a name for the cluster name
...
After some game matches, you should see something similar to that shown in the images below to prove that this data is now being stored in our new Couchbase database.
