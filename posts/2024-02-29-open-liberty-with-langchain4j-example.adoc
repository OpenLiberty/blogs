...
https://github.com/langchain4j/langchain4j[LangChain4J APIs] provide the capabilities to intergate LLMs into your Java application for different AI platforms, such as OpenAI and Hugging Face, etc.
...
To connect to the AI provider, such as Hugging Face used in the application, an API key is required.
