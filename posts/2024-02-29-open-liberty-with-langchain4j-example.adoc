...
examplelocation: https://github.com/gkwan-ibm/langchain4j-examples/blob/jee-mp-example/jakartaee-microprofile-example
---
...
{{page.examplelocation}}/src/main/java/dev/langchain4j/example/chat/AgentManager.java

{page.examplelocation}/src/main/java/dev/langchain4j/example/chat/AgentManager.java

"{{examplelocation}}/src/main/java/dev/langchain4j/example/chat/AgentManager.java"

"{examplelocation}/src/main/java/dev/langchain4j/example/chat/AgentManager.java"

{{page.examplelocation}}/src/main/java/dev/langchain4j/example/chat/AgentManager.java[`AgentManager` class]
[source, java]
----
