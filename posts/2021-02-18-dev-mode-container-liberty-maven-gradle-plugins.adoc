...
In this blog post, we announce the releases of the Liberty Maven Plug-in 3.3.3 and the Liberty Gradle Plug-in 3.1.1. These releases include the general availability of container support in dev mode, support for copying dependencies, and a number of other fixes.
