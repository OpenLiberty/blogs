...
In our link:/2020/06/04/asynchronous-programming-microprofile-fault-tolerance.html[previous blog post], we introduced what `@Asynchronous` does and some basic use cases that return a `CompletionStage`.
...
In our last post, we covered two use cases⁠—one about link:/2020/06/04/asynchronous-programming-microprofile-fault-tolerance.html#Applying-to-asynch-api[applying Fault Tolerance to an asynchronous API call] and the other about link://2020/06/04/asynchronous-programming-microprofile-fault-tolerance.html#Running-methods-in-parallel[running multiple methods in parallel].
