...
* link:{url-prefix}/docs/ref/general/#logging.html[Logging and tracing]
...
* link:{url-prefix}/docs/ref/config/#connectionFactory.html[`connectionFactory`]
* link:{url-prefix}/docs/ref/config/#jmsConnectionFactory.html[`jmsConnectionFactory`]
* link:{url-prefix}/docs/ref/config/#jmsQueueConnectionFactory.html[`jmsQueueConnectionFactory`]
* link:{url-prefix}/docs/ref/config/#jmsTopicConnectionFactory.html[`jmsTopicConnectionFactory`]
