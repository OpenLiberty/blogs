...
This example uses the `com.ibm.crypto.plus.provider.IBMJCEPlusFIPS` FIPS provider. We have already set `com.ibm.jsse2.usefipsProviderName=IBMJCEPlusFIPS` in jvm.options file in above step.
