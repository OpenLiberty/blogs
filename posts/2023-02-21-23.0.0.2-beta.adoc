...
[.img_border_light]
image::img/blog/ac_db_test_server_config.png[Server Config Tool,width=70%,align="center"]

Select "server.xml" to edit.

[.img_border_light]
image::img/blog/ac_db_test_serverxml.png[server.xml,width=70%,align="center"]

Navigate to the resource you would like to test and click the "Test" button.

[.img_border_light]
image::img/blog/ac_db_test_resource[Select resource,width=70%,align="center"]
...
+
[.img_border_light]
image::img/blog/ac_db_test_container_auth.png[Container authentication,width=70%,align="center"]
...
+
[.img_border_light]
image::img/blog/ac_db_test_app_auth.png[Application authentication,width=70%,align="center"]
...
+
[.img_border_light]
image::img/blog/ac_db_test_no_resource_ref.png[No Resource Reference,width=70%,align="center"]
...
[.img_border_light]
image::img/blog/ac_db_test_successful_test.png[Successful connection test example,width=70%,align="center"]
