...
Although this example uses the `mpOpenApi-3.0` and `appSecurity-4.0` features, you can use any valid version combination of the MicroProfile OpenAPI and Application Security (Jakarta Security) features.
