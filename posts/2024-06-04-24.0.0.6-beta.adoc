...
//
// Throughout the doc, replace 24.0.0.6-beta with the version number of Open Liberty, eg: 22.0.0.2-beta
// // // // // // // //
...
* <<SUB_TAG_0, Preview of Jakarta Validation 3.1>>
* <<SUB_TAG_1, MicroProfile Metrics 3.0/4.0 for 24.0.0.6-beta>>
* <<SUB_TAG_2, Instant Support for HTTP Session Cache in Liberty 24.0.0.6>>
