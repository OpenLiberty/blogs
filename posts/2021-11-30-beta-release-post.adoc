...
seo-title: MicroProfile 5, MicroProfile Rest Client 3.0 and JPA enhancements in Open Liberty 22.0.0.1-beta - OpenLiberty.io
...
For 22.0.0.1-beta, We have a single beta packages for link:{url-about}[Open Liberty]:
