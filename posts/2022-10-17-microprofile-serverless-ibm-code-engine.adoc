...
To be able to process CloudEvents in Open Liberty add the CloudEvents `restful-ws-jakarta` library to the application by adding this dependency to your `pom.xml`:
