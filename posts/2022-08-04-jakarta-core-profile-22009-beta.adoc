...
Enabling either the JSON-B 3.0 feature (`jsonb-3.0`) or the JSON-B 3.0 Container (`jsonbContainer-3.0`) feature automatically enables the JSON-P 2.1 feature (`jsonp-2.1`), unless you have enabled the JSON-P Container feature (`jsonpContainer-2.1`) in order to provide a third-party implementation of JSON-P.
