...
** Jakarta Annotation 2.1: allowing `@Priority` to be used on any program elements; adding `@Nullable` and `@NotNull`
...
* link:https://openliberty.io/guides/microprofile-openapi.html[Open Liberty MicroProfile OpenAPI guide]
