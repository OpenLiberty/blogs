...
After a couple of years of sporting a chef's hat at Enterprise Java conferences, Holly went further with her Java runtime crafting and made a cuddly throwable runtime. This was an actual cuddly ball with LEDs and a Raspberry Pi embedded in it which she would throw into the audience part-way through her talk and encourage them to chuck it around the room during her presentations.
...
Watch link:https://www.infoq.com/presentations/arduino-app-server/[Holly talk about her cuddly throwable runtime].
