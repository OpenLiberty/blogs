...
The `mpTelemetry-2.0` feature automatically starts the `monitor-1.0` feature. Enable the `mpTelemetry-2.0` feature and any features that are associated with your chosen supported runtime components.x
