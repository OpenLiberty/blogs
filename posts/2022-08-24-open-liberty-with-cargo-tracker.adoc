...
After cloning the project, import it into Eclipse by selecting the "File" menu and then "Import". Choose the "Existing Maven Projects" option inside the import menu. You'll need Eclipse JEE version 2022-03 or later to run the application. 

[.img_border_dark]
image::/img/blog/cargo-tracker-eclipse-import.png[Cargo Tracker Eclipse Import,width=90%,align="center"]

In the next step, select the repository base folder as the root directory and check the pom.xml under the "Projects" tab. Select "Finish". 
