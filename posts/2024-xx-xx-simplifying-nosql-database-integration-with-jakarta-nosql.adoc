...
image::/img/blog/jnopo-architecture-before-persistence.png[JNopo Sequence Diagram, align="center" width=60%]

=== JNopo Architecture

* Explain and show the JNopo architecture
* Show the JNopo Architecture diagram

== Challenge: Collect the game results in order to provide a winners ranking
