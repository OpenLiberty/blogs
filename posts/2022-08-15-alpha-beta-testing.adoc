...
RANDOM ACCESS model: image::/img/blog/AB-type-1.png[A/B testing on kubernetes - randon access setup architecture diagram,width=70%,align="center"]

TARGETED ACCESS model: image::/img/blog/AB-type-2.png[A/B testing on kubernetes - targeted access setup architecture diagram,width=70%,align="center"]
