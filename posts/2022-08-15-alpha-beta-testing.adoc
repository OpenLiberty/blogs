---
layout: post
title: "What is A/B testing - A sample Kubernetes implementation with canary deployment strategy"
categories: blog
author_picture: https://avatars3.githubusercontent.com/shamjithantholi
author_github: https://github.com/shamjithantholi
seo-title: A/B testing in Kubernetes with canary deployment
seo-description: Details about A/B Testing and a sample Using a Kubernetes Canary Deployment. 
blog_description: Details about A/B Testing and a sample Using a Kubernetes Canary Deployment. 
open-graph-image: https://openliberty.io/img/blog/liberty-devops-generic-architecture.png
---
= What is A/B testing - A sample Kubernetes implementation with canary deployment strategy
