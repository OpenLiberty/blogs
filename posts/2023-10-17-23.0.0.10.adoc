...
In this release of Open Liberty, we also have an update to the `featureUtility` command; the command now verifies feature authenticity by default when you install a new feature in to Liberty.
