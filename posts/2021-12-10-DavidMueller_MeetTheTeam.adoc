...
seo-description: David is a technical writer with the WebSphere Application Server ID team. For the past two years, he has served as the documentation focal for Open Liberty. In that capacity, he writes and edits topics for the Open Liberty docs , provides editorial reviews for Open Liberty blog posts and guides, and serves as a primary contact between the development and ID teams.
blog_description: David is a technical writer with the WebSphere Application Server ID team. For the past two years, he has served as the documentation focal for Open Liberty. In that capacity, he writes and edits topics for the Open Liberty docs , provides editorial reviews for Open Liberty blog posts and guides, and serves as a primary contact between the development and ID teams.
