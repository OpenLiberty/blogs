...
// tag::intro[]
link:{url-prefix}/blog/2020/06/05/graphql-open-liberty-20006.html[Open Liberty 20.0.0.6] introduces a new feature, link:https://github.com/eclipse/microprofile-graphql[MicroProfile GraphQL], which enables developers to quick and easily write GraphQL applications with MicroProfile.
