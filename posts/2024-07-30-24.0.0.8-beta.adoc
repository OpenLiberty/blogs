...
* <<rc, MicroProfile Rest Client 4.0: Align your REST client with Jakarta RESTful Web Services 3.1 >>
...
// // // // // // // //
[#rc]
== MicroProfile Rest Client 4.0: Align your REST client with Jakarta RESTful Web Services 3.1
...
In the 24.0.0.7-beta release, we introduced link:/blog/2024/07/02/24.0.0.7-beta.html#monitor10[Enhanced HTTP Request Monitoring with Monitor 1.0]. This update enables you to track HTTP requests made to the server and record the following data:
