...
The 24.0.0.8-beta release includes the beta release of MicroProfile 7.0 and the `microProfile-7.0` link:{url-prefix}/docs/latest/reference/feature/feature-overview.html#[convconvenience feature].
