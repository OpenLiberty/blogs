...
* <<data, Bring your own Jakarta Data provider with dataContainer-1.0>>
* <<faces, Bring your own Jakarta Faces implementation with  facesContainer-4.1>>
* <<websocket, Broadcast to multiple clients with Jakarta WebSocket 2.2>>
* <<jpa, Use Jakarta Persistance with improved type safety and other enhancements in persistence-3.2>>
...
MicroProfile Fault Tolerance helps you to easily identify and mitigate failures in your code. It provides annotations that you can add to methods to use bulkhead, circuit breaker, retry, timeout, and fallback strategies.
...
The new MicroProfile OpenAPI 4.0 feature (`mpOpenAPI-4.0`) supports for the latest version of the specification with the following changes:

Documentation is now produced in link:https://spec.openapis.org/oas/v3.1.0.html[OpenAPI 3.1 format], updated from 3.0 in previous versions. Changes in OpenAPI 3.1 include:
...
- Documenting more than one web module (as [can be configured in previous versions][multi-app])
- Validation of the produced OpenAPI document

=== Further resources:

- You can read more detail about the changes in MP OpenAPI 4.0 in the [specification][spec] and [API Javadoc][javadoc].
- You can learn more about how to use MicroProfile OpenAPI from our [documentation][docs] and [guide][guide].

[release-notes]: https://download.eclipse.org/microprofile/microprofile-open-api-4.0-RC4/microprofile-openapi-spec-4.0-RC4.html#release_notes_40
[multi-app]: https://openliberty.io/docs/latest/documentation-openapi.html#multi-module
[spec]: https://download.eclipse.org/microprofile/microprofile-open-api-4.0-RC4/microprofile-openapi-spec-4.0-RC4.html
[javadoc]: https://download.eclipse.org/microprofile/microprofile-open-api-4.0-RC4/apidocs/
...
[#data]
== Bring your own Jakarta Data provider with dataContainer-1.0
...
[#faces]
== Bring your own Jakarta Faces implementation with  facesContainer-4.1
...
[#jpa]
== Use Jakarta Persistance with improved type safety and other enhancements in persistence-3.2
