---
layout: post
title: "Log Throttling and Model Context Protocol Server 1.0 updates in 26.0.0.2-beta"
# Do NOT change the categories section
categories: blog
author_picture: https://avatars3.githubusercontent.com/navaneethsnair1
author_github: https://github.com/navaneethsnair1
seo-title: "Log Throttling and Model Context Protocol Server 1.0 updates in 26.0.0.2-beta- OpenLiberty.io"
...
---
= Log Throttling and Model Context Protocol Server 1.0 updates in 26.0.0.2-beta
...
For complete reference documentation, please see the link:https://jakarta.ee/specifications/security/[Jakarta Security Annotations specification].
...
* a name ("myKey")
* the whole key is seen as "example.com/myKey"
...
* When an asynchronous tool failed with a business exception, it was incorrectly treated as a non-business exception and the client would receive an "Internal server error" response. Now the business exception message is correctly returned to the user in the same way it is for synchronous tools.
