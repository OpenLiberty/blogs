...
image::img/blog/finding_14975_a.png[Issue 14975 labels]
...
. Search for 14975: 
image::img/blog/finding_14975_b.png[Issue 14975 in list] 
. Search back to find the fix pack:
image::img/blog/finding_21001.png[Fixpack 21.0.0.1] 


== Finding the fix pack for a non-'release bug' issue

Suppose that you have found issue 15987 OIDC state cookie cannot be read by another JVM in collective w/socal login TS004966274

* When you display the issue, you'll see the following in the Label list:
image::img/blog/finding_15987_a.png[Issue 15987 labels]
* There are two things to note here:
...
. Navigate to 15987 
. Find the pull request (PR) that fixes the issue, for this issue, it is 16150 
image::img/blog/finding_15987_b.png[Issue 15987's PR]
. Click on the link for PR 16150
. Search the text of the PR for revert "
** That is: revert, space, double quote, example (not in this PR): 
image::img/blog/revert_1.png[Revert]
...
image::img/blog/finding_16150_a.png[PR 16150 tabs]
. Click on the last commit for the PR (in this PR, there is only one): 
image::img/blog/finding_16150_b.png[PR 16150 commit]
...
image::img/blog/finding_16150_c.png[PR 16150 fix pack]
...
image::img/blog/revert_2.png[Revert Re-introduce]
