...
Come back to home page and click on '+ NEW APP'
...
[.img_border_light]
image::/img/blog/argocd-create-app1.png[ArgoCD home page1,width=60%, align="center" ]
[.img_border_light]
image::/img/blog/argocd-create-app2.png[ArgoCD home page2,width=60%, align="center" ]
