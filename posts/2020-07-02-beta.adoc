...
In no time at all, we have a second Open Liberty beta which makes available another three Jakarta EE 9 features (JDBC 4.2 & 4.3, JSON-B 2.0, JSON-P 2.0) plus JNDI 1.0 and underlying support for the Java Transaction API (JTA). This is in addition to the three features we beta'd in the link:/blog/2020/06/22/jakarta-ee-9-open-liberty-20007beta.html[first Open Liberty beta] (Servlet 5.0, Java Server Pages (JSP) 3.0, Expression Language 4.0).
...
----
<featureManager>
  <feature>jdbc-4.3</feature> // Java 11
  <feature>jdbc-4.2</feature> // Java 8
