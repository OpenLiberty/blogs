...
image::/img/blog/blog-2168-SNL-java-class.png[Java class sample,width=70%,align="center"]
...
image::/img/blog/blog-2168-SNL-TOC.png[Guide sample,width=70%,align="center"]

Or, you can navigate to different sections of the guide through the blue progress bar under the Table of Contents menu:

image::/img/blog/blog-2168-SNL-progress-bar.png[Guide sample,width=60%,align="center"]
