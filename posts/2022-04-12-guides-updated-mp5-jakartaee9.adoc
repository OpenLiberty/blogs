...
---
= TITLE
AUTHOR_NAME <https://github.com/gkwan-ibm>
:imagesdir: /
:url-prefix:
:url-about: /
...
image::/img/blog/blog-2168-SNL-java-class.png[Java class sample,width=50%,align="center"]
...
image::/img/blog/blog-2168-guide.png[Guide sample,width=50%,align="center"]
...
image::/img/blog/blog-2168-SNL-TOC.png[Guide sample,width=50%,align="center"]
...
* link:{url-prefix}/guides/rest-client-angular.htmlConsuming a RESTful web service with Angular^]
