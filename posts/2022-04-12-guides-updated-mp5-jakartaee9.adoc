...
seo-description: Learn how to develop cloud-native Java applications and microservices on Open Liberty with MicroProfile 5.0 and Jakarta EE 9.1 APIs using cloud-hosted guides on the openliberty.io website.
...
The cloud-hosted guides are enhanced with a new look and updated features. Whether or not you've tried them yet, now is the time to experience how easy you can learn to build applications with MicroProfile and Jakarta EE APIs.
