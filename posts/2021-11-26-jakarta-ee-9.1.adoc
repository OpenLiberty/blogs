...
Jakarta EE 9.1 support is now available in Open Liberty!!  This support allows you to run Jakarta EE 9 applications using Java 8, 11, or 17 with other Open Liberty value-add features that are updated to support Jakarta EE 9.  Many of you have followed our progress for delivering Jakarta EE 9.1 via our beta releases and corresponding blogs, and we'd like to thank those that provided feedback along the way.  
...
For more information, see the link:https://staging-openlibertyio.mybluemix.net/docs/21.0.0.12/reference/jakarta-ee9-feature-updates.html[Jakarta EE 9 feature updates] documentation.
For details regarding the APIs and SPIs, check out the link:https://staging-openlibertyio.mybluemix.net/docs/21.0.0.12/reference/javadoc/liberty-jakartaee9.1-javadoc.html[Jakarta EE 9.1 javadoc].
