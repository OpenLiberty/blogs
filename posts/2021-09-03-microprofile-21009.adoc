...
To get started with and learn more about MicroProfile Health, check out our link:https://openliberty.io/guides/microprofile-health.html[MicroProfile Health guide].
