...
MicroProfile Telemetry 2.1(`mpTelemetry-2.1`) provides developers with updated Open Telemetry technology as the feature now uses OpenTelemetry v1.48.0, which was updated from v1.39.0. The previous exposed experimental APIs are now stable.
