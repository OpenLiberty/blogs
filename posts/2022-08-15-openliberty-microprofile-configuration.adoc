...
[cols=">a,<a", frame=none, grid=none]
|===
| image::/img/blog/secrets-as-config.png[OpenShift secret as config view,width=40%,align="center"]
| image::/img/blog/oc-secret-config-result.png[ConfigMap as secret result view,width=70%,align="center"]
|===
