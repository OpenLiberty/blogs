...
image::/img/blog/oc-config.png[OpenShift secret view,width=50%,align="center"]

Map the secret to environment variable as the data source

image::/img/blog/secrets-as-config.png[OpenShift secret as config view,width=50%,align="center"]
