...
image::/img/blog/oc-config.png[OpenShift secret view, width=400, height=150vw, align="center"]

Now map the secret to environment variable as the data source and access the variable from the application.

image::/img/blog/secrets-as-config.png[OpenShift secret as config view,width=400, height=400 ,align="left"]
