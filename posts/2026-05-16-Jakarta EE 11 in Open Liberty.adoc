...
== Spring Boot 4.0 
Open Liberty also enables Spring Boot 4.0 applications, allowing you to leverage the latest features and improvements in the Jakarta EE 11 release. You can enable Spring Boot 4.0 feature in your `server.xml`:
[source,xml]
----
<featureManager>
