...
If your application uses `@ManagedBean`, you must migrate to CDI managed beans. The `@ManagedBean` annotation was deprecated in Java EE 6 and has been removed in Jakarta EE 11.
...
3. **Use EJB annotations** - If the bean requires transaction management or other EJB services
