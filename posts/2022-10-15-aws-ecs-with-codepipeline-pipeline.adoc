...
image::/img/blog/openliberty-ecr-api1.png[ECR API endpoint,width=80%,align="left"]

image::/img/blog/openliberty-ecr-ap2.png[ECR API endpoint,width=80%,align="left"]
