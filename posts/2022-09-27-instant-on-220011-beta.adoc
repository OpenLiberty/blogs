...
To build and run container images which use `criu`, the host Operating System will need few prerequisites installed. All testing has been done on RHEL 8.6 and RHEL 9.0.  Other Linux distributions and versions may be possible if they have the necessary prerequisites.  The following is required:
