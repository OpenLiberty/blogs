...
seo-description: With updates to all 8 MicroProfile componenets, MicroProfile 4.0 is now generally available in Open Liberty 21.0.0.3.
blog_description: With updates to all 8 MicroProfile componenets, MicroProfile 4.0 is now generally available in Open Liberty 21.0.0.3.
