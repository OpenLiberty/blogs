...
This beta release updates `mcpServer-1.0` to use the link:https://central.sonatype.com/artifact/org.mcpjava/mcp-server-api[MCP Java API], improves MCP metrics MBean naming, and fixes the MCP endpoint URL log message. Open Liberty 26.0.0.9-beta is targeted at application developers building MCP-enabled Liberty applications.
