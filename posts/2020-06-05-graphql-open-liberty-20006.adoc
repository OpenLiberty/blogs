...
If you do not already have Grafana and Prometheus set up, there is a Kabanero guide for link:https://kabanero.io/guides/app-monitoring-ocp4.2/[Red Hat OpenShift Container Platform 4.3] as well as a blog post for link:{url-prefix}/blog/2020/04/09/microprofile-3-3-open-liberty-20004.html#gra[standalone] Open Liberty to help get started.
...
Find out more about application properties link:{url-prefix}/docs/ref/config/#application.html[here].
