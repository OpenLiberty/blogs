...
- visit link:https://openliberty.io/guides/?search=microprofile&key=tag[the guides introduced with Micro Profile]
- visit link:https://openliberty.io/guides/?search=jakarta%20ee&key=tag[the guides introduced with Jakarta EE]
