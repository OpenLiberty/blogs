...
=== Gradle project
If you selected Gradle as your build tool, examine the `app-name` demo project directory to locate the `build.gradle` file.
...
image::img/blog/liberty-app-directory-img.png[MAVEN-APP and GRADLE-APP directory image,width=40%,align="center"]
...
Please check out the project and ensure that Liberty dev mode is running for your project. Then, create a new Java class file named `HelloWorldResource.java` as the REST resource.
