...
* `@P` annotation describes each parameter so the LLM can understand what information to provid, format the parameter correctly, and extract relevant details from the user's query.
