...
The following sample application demonstrates all these components in a working Stack Overflow search assistant. The complete code is available in the https://github.com/OpenLiberty/sample-langchain4j/tree/main/tools[sample-langchain4j/tools] repository, which we'll examine in detail.

For more examples beyond what is covered here, you can also explore the official https://github.com/langchain4j/langchain4j-examples[langchain4j-examples] repository.
...
Some good practices for implementing tools include:
