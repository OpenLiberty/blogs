...
seo-title: UserRegistry Attribute Reader Enhancement, Jandex Index Format Support Update and more in 26.0.0.3- OpenLiberty.io
...
blog_description: This release introduces UserRegistry Attribute Reader APIs for retrieving user attributes from LDAP and custom registries, and adds support for Jandex index formats 11-13 to improve application startup performance. Other highlights include changes to AES encoding and fixes for security vulnerabilities and bugs. 
open-graph-image: https://openliberty.io/img/twitter_card.jpg
open-graph-image-alt: Open Liberty Logo
blog-available-in-languages:
- lang: ja
  path: /ja/blog/2026/03/24/26.0.0.3.html
---
...
// // // // DO NOT MODIFY THIS COMMENT BLOCK <GHA-BLOG-TOPIC> // // // // 
// Blog issue: https://github.com/OpenLiberty/open-liberty/issues/34518
...
[source,bash]
----
wlp\bin>securityUtility encode --encoding=aes --key=mycustomkey "password"
...
For more information, see the full documentation for link:https://openliberty.io/docs/latest/reference/command/securityUtility-encode.html[securityUtility encode] and link:https://openliberty.io/docs/latest/password-encryption.html[password encryption].
