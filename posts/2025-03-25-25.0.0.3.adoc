...
Before this update, FIPS 140-2 was supported, but its certification for IBM SDK 8 is now expired. The new FIPS 140-3 support provides an updated and more secure cryptographic module for Liberty users who use IBM SDK 8. For information about supported operating systems and more, see link:https://www.ibm.com/docs/en/sdk-java-technology/8?topic=guide-fips-140-3[FIPS 140-3] in the IBM SDK 8 documentation.
