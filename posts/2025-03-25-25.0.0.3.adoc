...
For more information, see link:https://ibmdocs-test.dcs.ibm.com/docs/en/SSAW57_liberty_test?topic=liberty-configuring-ltpa-in[Configuring LTPA in Liberty].
