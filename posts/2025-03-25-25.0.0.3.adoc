...
+
If you have LTPA link:{url-prefix}/docs/latest/reference/feature/appSecurity-5.0.html#validationkeys[validation keys], you must also delete these and generate new validation keys after FIPS 140-3 is enabled. You can generate new validation keys by using the `securityUtility createLTPAKeys` command, as demonstrated in the following examples.
+
