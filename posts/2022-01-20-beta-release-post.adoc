...
Currently, Open Liberty Server does not support this new url-encoded certificate. Any request with this new format is rejected and the request is terminated.
...
The Open Liberty code is updated to auto detect and process this new format.
