...
categories: blog
author_picture: https://avatars3.githubusercontent.com/gljrobinson
author_github: https://github.com/gljrobinson
...
Grace Robinson <https://github.com/gljrobinson>
:imagesdir: /
:url-prefix:
:url-about: /
...
+
In this session, Open Liberty's https://twitter.com/gracejansen27[Grace Robinson] will dive into the extended and updated 15 factors needed to build cloud-native applications that are able to thrive in the cloud, and she'll take a look at the open source technologies and tools that can help us achieve this.
