---
layout: post
title: "Log throttling and noteable bug fixes in 26.0.0.1"
# Do NOT change the categories section
categories: blog
author_picture: https://avatars3.githubusercontent.com/navaneethsnair1
author_github: https://github.com/navaneethsnair1
seo-title: Log throttling and noteable bug fixes in 26.0.0.1- OpenLiberty.io
...
---
= Log throttling and noteable bug fixes in 26.0.0.1
