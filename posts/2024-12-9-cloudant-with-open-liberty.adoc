---
layout: post
title: "Access a Cloudant NoSQL database with Open Liberty using CDI"
categories: blog
author_picture: https://avatars3.githubusercontent.com/revijay
author_github: https://github.com/revijay
seo-title: Access a Cloudant NoSQL database with Open Liberty using CDI - OpenLiberty.io
...
---
= Access a Cloudant NoSQL database with Open Liberty using CDI
