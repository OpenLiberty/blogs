...
For a closer look at the changes you make to the Petclinic application to run it on Open Liberty, see this https://github.com/spring-projects/spring-petclinic/compare/cf6d44b045f6cafe6c2c50b38d9de39389801ba5...cbridgha:spring-petclinic:RunAsWarOnLiberty[change comparison on GitHub].
