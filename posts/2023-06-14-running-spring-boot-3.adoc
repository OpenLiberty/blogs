...
seo-description: In version 22.0.0.3 and later, you can easily run a Spring Boot 3.x application from a WAR file on Open Liberty. 
blog_description: In version 22.0.0.3 and later, you can easily run a Spring Boot 3.x application from a WAR file on Open Liberty.  
...
In version 22.0.0.3 and later, you can easily run a Spring Boot 3.x application from a WAR file on Open Liberty.
...
You ran a sample Spring Boot 3 application from a WAR file on Open Liberty. These steps demonstrate a simple way to create and run any WAR file from an existing Spring Boot application on Liberty.

For a closer look at the changes you make to the Petclinic sample application to run it on Open Liberty, see this https://github.com/spring-projects/spring-petclinic/compare/cf6d44b045f6cafe6c2c50b38d9de39389801ba5...cbridgha:spring-petclinic:RunAsWarOnLiberty[change comparison on GitHub].
