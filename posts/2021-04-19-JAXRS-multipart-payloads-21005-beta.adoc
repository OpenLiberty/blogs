...
With Open Liberty 21.0.0.5-beta yous can now build multipart payloads for your JAX-RS client and services. Also present in this release is Jakarta EE 9 support for `oauth-2.0` and `samlWeb-2.0`.
