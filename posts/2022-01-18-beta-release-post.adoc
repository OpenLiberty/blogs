...
As of 21.0.0.12 the Jakarta EE 9.1 features are now out of beta and fully supported.  That means that you can either use them in the official 22.0.0.1 release, or continue to use them in the beta 22.0.0.2-beta package.  Just as before, you can enable the individual features you want or you can just add the Jakarta EE 9.1 convenience feature to enable all of the Jakarta EE 9.1 beta features at once:
