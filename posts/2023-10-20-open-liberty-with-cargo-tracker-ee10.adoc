...
image::/img/blog/cargo-tracker-ee10-dashboard.png[Cargo Tracker Dashboard,width=60%,align="left"]
image::/img/blog/cargo-tracker-ee10-event-logger.png[Cargo Tracker Event Logger,width=20%,align="right"]
