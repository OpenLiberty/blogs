...
image::/img/blog/cargo-tracker-ee10-dashboard.png[Cargo Tracker Dashboard,width=50%,align="left"]
image::/img/blog/cargo-tracker-ee10-event-logger.png[Cargo Tracker Event Logger,width=50%,align="right"]
