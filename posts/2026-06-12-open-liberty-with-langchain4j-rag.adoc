...
To learn more about how vector search works, explore https://www.ibm.com/think/topics/vector-embedding[Vector Embeddings] and https://www.ibm.com/think/topics/vector-search[Vector Search].
