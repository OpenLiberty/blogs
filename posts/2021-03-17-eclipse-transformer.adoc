...
This article describes how application developers can use the Eclipse Transformer to update their applications and test artifacts to run using Jakarta EE 9, and describes steps necessary to update Open Liberty server configurations to run Jakarta EE 9 applications.
