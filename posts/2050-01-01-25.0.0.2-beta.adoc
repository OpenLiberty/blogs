...
---
= TITLE
testing only <https://github.com/navaneethsnair1>
:imagesdir: /
:url-prefix:
:url-about: /
...
// Replace testing only with your name as you'd like it to be displayed,
// eg: LauraCowen
//
...
//
// Throughout the doc, replace 25.0.0.2-beta with the version number of Open Liberty, eg: 22.0.0.2-beta
// // // // // // // //

The link:{url-about}[Open Liberty] 25.0.0.2-beta includes the following beta features (along with link:{url-prefix}/docs/latest/reference/feature/feature-overview.html[all GA features]):
...
// "The link:{url-about}[Open Liberty] 25.0.0.2-beta includes SUB_FEATURE_TITLE"
// // // // // // // //
...
```
For more information, regarding the audit feature, please refer to the following Open Liberty link:https://openliberty.io/docs/latest/reference/feature/audit-1.0.html[documentation].
