...
For a full getting-started guide and examples, see the link:{url-prefix}/blog/2026/08/25/26.0.0.9-beta.html[Expose your Liberty business logic as AI tools blog post] and the `mcp-1.0` feature documentation (link to be added when MCP docs are published).
