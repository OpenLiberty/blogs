...
A fuller explanation of Samesite support on Open Liberty can now be found in link:{url-prefix}/blog/2020/03/25/set-samesite-attribute-cookies-liberty.html[Paul's blog post].
