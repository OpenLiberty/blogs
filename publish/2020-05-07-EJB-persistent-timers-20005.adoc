...
Keep in mind, between link:https://www.eclipse.org/openj9/[Eclipse OpenJ9] and link:https://openjdk.java.net/groups/hotspot/[Hotspot], OpenJ9 link:{url-prefix}/blog/2019/10/30/faster-startup-open-liberty.html[typically offers faster startup times] and a lower memory footprint than Hotspot.
