...
View the list of fixed bugs in link:https://github.com/OpenLiberty/open-liberty/issues?q=label%3Arelease%3A|RELEASE_VERSION|+label%3A%22release+bug%22[RELEASE_VERSION].
// end::intro[]

// // // // // // // //
// Above:
// Replace |RELEASE_VERSION| with the the version number of Open Liberty. e.g. 20.0.0.10
// Also replace [RELEASE_VERSION] with the Open Liberty version number. e.g. [20.0.0.10]
// // // // // // // //
