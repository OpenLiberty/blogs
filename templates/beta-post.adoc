...
// // // // // // // //
// Change the RELEASE_SUMMARY to a introductory paragraph. This sentence is really
...
// // // // // // // //
// ABOVE:
// Change the SUB_FEATURE_TITLE above to list the new changes and features in this
// Jakarta EE release
// // // // // // // //
