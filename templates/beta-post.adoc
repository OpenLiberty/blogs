...
// // // // // // // //
// Provide a paragraph describing the release provide a list of all the features and changes that are              // being introduced in this release
// // // // // // // //
These join the Jakarta EE 9 features in link:/blog/2020/07/07/jakartaee9-data-source-transactions-RELEASE_VERSION-beta.html[previous Open Liberty betas]:

// // // // // // // //
// List the features and changes from previous release
// // // // // // // //
...
// // // // // // // //
// List another(main) feature/change
// // // // // // // //
