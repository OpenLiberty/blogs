...
As you'll have come to expect from the Open Liberty project, we've got the latest MicroProfile version all done and dusted before the end of the year. We like to think of MicroProfile 2.1 as "laser-focused" with its singular dedication in this release to updating the MicroProfile Open Tracing 1.2 feature.
