...
Support for TLSv1.3 has been turned on for OpenJDK 11 with Hotspot, meaning that Open Liberty will now work with both of the main JVMs (OpenJ9 and Hotspot).
