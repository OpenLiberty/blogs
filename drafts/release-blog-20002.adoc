...
Open Liberty 20.0.0.2 provides bug fixes and quality improvements. To run link:https://openliberty.io/about/[Open Liberty] 20.0.0.2 with Maven, Gradle, or in Docker, take a look at our link:https://openliberty.io/downloads/[Downloads page].

[link=https://stackoverflow.com/tags/open-liberty]
image::https://openliberty.io/img/blog/blog_btn_stack.svg[Ask a question on Stack Overflow, align="center"]

You can now  try out early implementations of some new capabilities in the link:{url-prefix}/downloads/#development_builds[latest Open Liberty development builds]. These early implementations are not available in 20.0.0.2, but you can try them out in our daily Docker image by running `docker pull openliberty/daily`. Let us know what you think!
