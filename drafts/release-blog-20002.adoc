---
layout: post
title: A preview into support for MicroProfile 3.3 on Open Liberty
categories: blog
author_picture: https://avatars3.githubusercontent.com/yasmin-aumeeruddy
author_github: https://github.com/yasmin-aumeeruddy
seo-title: TITLE FOR  Open Liberty 20.0.0.2
...
---
= A preview into support for MicroProfile 3.3 on Open Liberty
Yasmin Aumeeruddy <https://github.com/yasmin-aumeeruddy>

link:https://openliberty.io/about/[Open Liberty]

Open Liberty 20.0.0.2 provides bug fixes and quality improvements.  If you're curious about what's coming in future Open Liberty releases, take a look at our <<previews,previews in the latest development builds>>. In particular, get an early insight into support for MicroProfile 3.3 on open Liberty.
[#run] 
...
https://github.com/eclipse/microprofile-config/milestone/7?closed=1[Changes to the API since 1.3]
...
* https://openliberty.io/docs/ref/config/#logging.html[Configuration]
