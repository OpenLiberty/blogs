...
seo-description: You can use the Kafka client API, allowing users to access Kafka specific message properties. Also add the SameSite Cookie on the session, with three values on the SameSite attribute.
blog_description: You can use the Kafka client API, allowing users to access Kafka specific message properties. Also add the SameSite Cookie on the session, with three values on the SameSite attribute.
---
