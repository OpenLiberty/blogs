...
seo-title: title in Open Liberty 20.0.0.3  you now have the ability to add the SameTime Cookie on the session, this includes three values on the SameTime attribute. As well, you now have the ability to use the Kafka client API allowing users to access Kafka specific message properties, not just the payload of the specific message as you had previously with MicroProfile Reactive `Message` API - OpenLiberty.io
seo-description: In Open Liberty 20.0.0.3, you now have the ability to add the SameTime Cookie on the session, this includes three values on the SameTime attribute. As well, you now have the ability to use the Kafka client API allowing users to access Kafka specific message properties, not just the payload of the specific message as you had previously with MicroProfile Reactive `Message` API description.  
blog_description: In Open Liberty 20.0.0.3, you now have the ability to add the SameTime Cookie on the session, this includes three values on the SameTime attribute. As well, you now have the ability to use the Kafka client API allowing users to access Kafka specific message properties, not just the payload of the specific message as you had previously with MicroProfile Reactive `Message` API.
---
