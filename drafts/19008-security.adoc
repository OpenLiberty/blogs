...
The public certificate from Google was added to the client, and certificates exchanged between client and microservice as described https://www.ibm.com/support/knowledgecenter/SSEQTP_liberty/com.ibm.websphere.wlp.doc/ae/twlp_add_trust_cert.html[here].
